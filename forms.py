"""
Created by newming at 2018/10/3
"""
...
class NewsForm(FlaskForm):
	...
	content = TextAreaField(label='新闻内容', validators=[DataRequired('请输入内容')],
							description='请输入内容', render_kw={'required': 'required', 'class': 'form-control'})
	types = SelectField(label='新闻类型', choices=[('推荐', '推荐'), ('百家', '百家'), ('本地', '本地'), ('图片', '图片')])
